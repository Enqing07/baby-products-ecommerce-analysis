...
Despite generating KSh 64.9 million in total sales, the business lacked clear visibility into what was truly driving its revenue, whether its discount strategies were effective, and how return behavior was impacting profitability. 
This dashboard was built to answer:

> *"How can the business leverage existing sales data uncover actionable insights that will optimize product offerings, pricing strategies, understand customer behavior, and improve operational decisions to sustain growth and profitability?"*

---

## Dataset
- Source: [Kaggle - Ecommerce Sales Data](https://www.kaggle.com/datasets/kaninigichuyia/ecommerce-sales-data)
- Period: November 2020 – October 2023
- Records: 28,755 transactions
- Attributes: 17 original columns + 9 derived features
- Domain: Baby products retail (Kenya-based)
...
| Gross Sales Trend Over Time | Quarterly sales trend from Q4 2020 to Q3 2023 |
